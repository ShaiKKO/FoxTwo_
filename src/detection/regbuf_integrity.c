 ...
 */
static VOID MonRegBufInitViolationInfo(_Out_ PMON_REGBUF_VIOLATION_INFO Info,
...
_Use_decl_annotations_ BOOLEAN MonIsRegBuffersValidationAvailable(VOID) {
  return MonGetIoRingOffsets() != NULL;
}

_Use_decl_annotations_ ULONG MonValidateIoRingRegBuffers(PVOID IoRingObject,
                                                         PMON_REGBUF_VIOLATION_INFO ViolationInfo) {
  return MonValidateIoRingRegBuffersEx(IoRingObject, MON_REGBUF_DEFAULT_MAX_ENTRIES, ViolationInfo);
}

_Use_decl_annotations_ ULONG MonValidateIoRingRegBuffersEx(
    PVOID IoRingObject, ULONG MaxEntriesToInspect, PMON_REGBUF_VIOLATION_INFO ViolationInfo) {
