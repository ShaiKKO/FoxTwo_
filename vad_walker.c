...
MonVadResolveOffsets(VOID)
{
    ...
    switch (buildNumber) {
        ...
        default:
            ...
            status = MonOffsetResolverGetVadOffsets(
                &g_VadRootOffset, &g_StartingVpnOffset,
...
)
{
    ...
    __try {
        ...
        Info->EndAddress = (((ULONG64)endingVpnHigh << 32 | endingVpn) << PAGE_SHIFT) +
                           PAGE_SIZE - 1;
        ...
        Info->IsWritable = (protection == 4 || protection == 5 ||
                           protection == 6 || protection == 7);
...
)
{
    ...
    switch (vadType) {
        case 0: return MonVadType_Private;
        case 1: return MonVadType_Mapped;
        case 2: return MonVadType_Image;
        case 3: return MonVadType_Physical;
        case 4: return MonVadType_WriteWatch;
        case 5: return MonVadType_LargePages;
        case 6: return MonVadType_Rotate;
        default: return MonVadType_Unknown;
    }
}
...
VOID
MonVadCheckAnomaly(
    _In_ PMON_VAD_INFO Info,
    _Inout_ PMON_VAD_SCAN_RESULT Result
)
{
...
MonVadWalkNode(
    _In_ PVOID VadNode,
    _Inout_ PMON_VAD_SCAN_RESULT Result,
    _In_ ULONG MaxDetails,
    _Inout_ ULONG* DetailIndex
)
{
...
)
{
    ...
    *BytesWritten = 0;
    ...
    if (frequency.QuadPart > 0) {
        result->ScanDurationUs = (ULONG)(
            (endTime.QuadPart - startTime.QuadPart) * 1000000 / frequency.QuadPart);
    }
