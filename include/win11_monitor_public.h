 ...
 *  - SECURITY: No raw kernel addresses are returned; the Address field is
 * masked.
 */
...
#define IOCTL_MONITOR_INTERCEPT_VALIDATE \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x20, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define IOCTL_MONITOR_INTERCEPT_SET_POLICY \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x21, METHOD_BUFFERED, FILE_WRITE_ACCESS)
...
#define IOCTL_MONITOR_INTERCEPT_GET_POLICY \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x22, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_INTERCEPT_GET_STATS \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x23, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_INTERCEPT_RESET_STATS \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x24, METHOD_BUFFERED, FILE_WRITE_ACCESS)
...
#define IOCTL_MONITOR_INTERCEPT_ENABLE \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x25, METHOD_BUFFERED, FILE_WRITE_ACCESS)
...
#define IOCTL_MONITOR_INTERCEPT_ADD_BL \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x26, METHOD_BUFFERED, FILE_WRITE_ACCESS)
...
#define IOCTL_MONITOR_INTERCEPT_REMOVE_BL \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x27, METHOD_BUFFERED, FILE_WRITE_ACCESS)
...
#define IOCTL_MONITOR_INTERCEPT_GET_BL \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x28, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_PROFILE_GET \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x30, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_PROFILE_LIST \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x31, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_PROFILE_EXPORT_ML \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x32, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_PROFILE_GET_STATS \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x33, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_PROFILE_GET_CONFIG \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x34, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_PROFILE_SET_CONFIG \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x35, METHOD_BUFFERED, FILE_WRITE_ACCESS)
...
#define IOCTL_MONITOR_PROFILE_RESET \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x36, METHOD_BUFFERED, FILE_WRITE_ACCESS)
...
#define IOCTL_MONITOR_ANOMALY_GET_RULES \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x38, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_ANOMALY_SET_THRESHOLD \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x39, METHOD_BUFFERED, FILE_WRITE_ACCESS)
...
#define IOCTL_MONITOR_ANOMALY_ENABLE_RULE \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x3A, METHOD_BUFFERED, FILE_WRITE_ACCESS)
...
#define IOCTL_MONITOR_ANOMALY_GET_STATS \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x3B, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_ANOMALY_RESET_STATS \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x3C, METHOD_BUFFERED, FILE_WRITE_ACCESS)
...
#define IOCTL_MONITOR_MEM_SCAN_VAD \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x40, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_MEM_GET_MDLS \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x41, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_MEM_SCAN_PHYSICAL \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x42, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_MEM_GET_SHARING \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x43, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_MEM_GET_STATS \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x44, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_XP_GET_SHARED \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x50, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_XP_GET_TREE \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x51, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_XP_SCAN_SECTIONS \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x52, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_XP_GET_ALERTS \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x53, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_XP_GET_STATS \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x54, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_XP_GET_CONFIG \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x55, METHOD_BUFFERED, FILE_READ_ACCESS)
...
#define IOCTL_MONITOR_XP_SET_CONFIG \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x56, METHOD_BUFFERED, FILE_WRITE_ACCESS)
...
#define IOCTL_MONITOR_XP_SCAN_NOW \
  CTL_CODE(FILE_DEVICE_UNKNOWN, WIN11MON_IOCTL_BASE + 0x57, METHOD_BUFFERED, FILE_WRITE_ACCESS)
