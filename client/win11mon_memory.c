 ...
 *-------------------------------------------------------------------------*/
static const WCHAR* g_AnomalyStrings[] = {
    L"None",
    L"Executable Heap",
...
Win11MonMemScanPhysical(
    HANDLE hDevice,
    DWORD ProcessId,
    PWIN11MON_PHYSICAL_SCAN_RESULT pResult
)
{
    MEM_SCAN_INPUT input;
    DWORD bytesReturned;
...
)
{
    ...
    switch (Protection) {
        case 0: /* PAGE_NOACCESS */
            flags[0] = L'-'; flags[1] = L'-'; flags[2] = L'-';
            break;
        case 1: /* PAGE_READONLY */
            flags[0] = L'R'; flags[1] = L'-'; flags[2] = L'-';
            break;
        case 2: /* PAGE_EXECUTE */
            flags[0] = L'-'; flags[1] = L'-'; flags[2] = L'X';
            break;
        case 3: /* PAGE_EXECUTE_READ */
            flags[0] = L'R'; flags[1] = L'-'; flags[2] = L'X';
            break;
        case 4: /* PAGE_READWRITE */
            flags[0] = L'R'; flags[1] = L'W'; flags[2] = L'-';
            break;
        case 5: /* PAGE_WRITECOPY */
            flags[0] = L'R'; flags[1] = L'C'; flags[2] = L'-';
            break;
        case 6: /* PAGE_EXECUTE_READWRITE */
            flags[0] = L'R'; flags[1] = L'W'; flags[2] = L'X';
            break;
        case 7: /* PAGE_EXECUTE_WRITECOPY */
            flags[0] = L'R'; flags[1] = L'C'; flags[2] = L'X';
            break;
        default:
            flags[0] = L'?'; flags[1] = L'?'; flags[2] = L'?';
            break;
